class PaymentManager {
  constructor() {
    this.baseApiUrl = 'http://localhost/hospital_billing2/api/transactions/payment.php';
    this.admissionApiUrl = 'http://localhost/hospital_billing2/api/transactions/admission.php';
    this.billingApiUrl = 'http://localhost/hospital_billing2/api/transactions/billing.php';
    this.insuranceApiUrl = 'http://localhost/hospital_billing2/api/insurance_provider.php';
    this.admissions = [];
